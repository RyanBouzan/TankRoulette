...
namespace TankRoulette
{
    public class BootstrapManager : MonoBehaviour
    {
        ...
        //broadcast reciever 
        private void OnLobbyClose(LobbyCloseBroadcast broadcast)
        {
            ...
            CurrentLobbyID = 0;
            string[] scenesToClose = { "Scne", "Main men" };



            Debug.LogWarning("is server?: " + instance._networkManager.IsServer + "\n is owner?: " + instance.isLobbyOwner);

            if (instance._networkManager.IsServer || instance.isLobbyOwner)
            ...
            BootstrapNetworkManager.ChangeNetworkScene("Main men", scenesToClose, broadcast.inGame);
        ...
        void OnLobbyDataUpdate(LobbyDataUpdate_t result)
    {
        ...
        private void OnLobbyCreated(LobbyCreated_t callback)
        {
            ...
            SteamMatchmaking.SetLobbyData(id, "tank_roulette", "8781");
       ...
       //     Debug.Log("Lobby creation was successful");
        ...
        private void OnLobbyEntered(LobbyEnter_t callback)
        {
            ...
            MainMenuManager.LobbyEntered(SteamMatchmaking.GetLobbyData(lobbyID, "name"), _networkManager.IsServer);
        ...
        void PrintLobbyMetadata(CSteamID lobbyID)
    {
        ...
        public static void LeaveLobby(bool inGame = false)
        {
            ...
            else
            {
                ...
                if (inGame)
                {
                    SceneManager.UnloadSceneAsync("Scne");
